...
shinyUI(pageWithSidebar(
    ...
    sidebarPanel(
        ...
        br(),
        br(),
        p("View source code on",
          a("github", 
            href = "https://github.com/Dipak22/DataProducts_Assessment", target = "_blank")),
        p("Click", 
          a("here", href = "https://github.com/Dipak22/DataProducts_Assessment/AppExplore", target = "_blank"), "for documentation"),
